 ...
 */
#ifndef _GL_TEXTOBJ_H
#define _GL_TEXTOBJ_H

#include "X11/gl/object.h"

typedef struct _GL_TextObjectInfo {
  char *data;
  int strlength;
  int ascent,descent;
} GL_TextObjectInfo;

void _GL_VA_Init_TextObject();
void _GL_VA_Handle_TextObject();
void _GL_VA_Execute_TextObject();

#define GL_TextObject _GL_VA_Init_TextObject, _GL_VA_Handle_TextObject, \
                      _GL_VA_Execute_TextObject, _GL_VA_Destroy_Object, \
                      _GL_VA_Return_Object

#define GLTO 2000

#define GLTO_String GLTO
