 ...
 */
#ifndef _GL_LINEOBJ_H
#define _GL_LINEOBJ_H

#include "X11/gl/object.h"

typedef struct _GL_LineObjectInfo {
  int x1,y1,x2,y2;
  int haveline;
} GL_LineObjectInfo;

void _GL_VA_Init_LineObject();
void _GL_VA_Handle_LineObject();
void _GL_VA_Execute_LineObject();

#define GL_LineObject _GL_VA_Init_LineObject, _GL_VA_Handle_LineObject, \
                      _GL_VA_Execute_LineObject, _GL_VA_Destroy_Object, \
                      _GL_VA_Return_Object

#define GLLO 2000

#define GLLO_LinePos GLLO
