 ...
 */
#ifndef _GL_INVERTRECT_H
#define _GL_INVERTRECT_H

#include "X11/gl/object.h"

void _GL_VA_Handle_InvertibleRectangle();
void _GL_VA_Execute_InvertibleRectangle();

#define GL_InvertibleRectangle _GL_VA_Init_Object, _GL_VA_Handle_InvertibleRectangle, \
                               _GL_VA_Execute_InvertibleRectangle, _GL_VA_Destroy_Object, \
                               _GL_VA_Return_Object

#define GLIR 2000

#define GLIR_InvertRect GLIR
