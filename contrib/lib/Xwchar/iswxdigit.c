/*
 * $XConsortium: iswxdigit.c,v 1.4 91/07/01 11:01:06 xguest Exp $
 */
...
/*
 * true if wc is DIS 10646's xdigit, i.e,
 *	code from 0x20202030 to 0x20202039.
 *	code from 0x20202041 to 0x20202046.
 *	code from 0x20202061 to 0x20202066.
 */

#if NeedFunctionPrototypes
 int iswxdigit(register wint_t wc)
#else
 int iswxdigit(wc)
 register wint_t wc;
#endif
