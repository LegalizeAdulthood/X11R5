/*
 * $XConsortium: iswalnum.c,v 1.4 91/07/01 11:00:26 xguest Exp $
 */
...
/*
 * true if wc is DIS 10646's alphabet or digit, i.e,
 *	code from 0x20202030 to 0x20202039
 *	code from 0x20202041 to 0x2020205a
 *	code from 0x20202061 to 0x2020207a
 */

#if NeedFunctionPrototypes
 int iswalnum(register wint_t wc)
#else
 int iswalnum(wc)
 register wint_t wc;
#endif
