/*
 * $XConsortium: towlower.c,v 1.4 91/07/01 11:01:15 xguest Exp $
 */
...
/*
 * convert character DIS 10646's upper to lower, i.e,
 *	FROM code from 0x20202041 to 0x2020205a.
 *	TO   code from 0x20202061 to 0x2020207a.
 */
