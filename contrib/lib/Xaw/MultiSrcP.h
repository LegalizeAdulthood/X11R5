/*
* $XConsortium: MultiSrcP.h,v 1.8 91/02/20 17:58:15 converse Exp $
*/
...
typedef struct _MultiPiece {	/* Piece of the text file of BUFSIZ allocated 
				   characters. */
  wchar * text;			/* The text in this buffer. */
...
typedef struct _MultiSrcPart {
  ...
  XtPointer string;		/* either the string, or the
				   file name, depending upon the type. */
  XawMultiType type;		/* either string or disk. */
