...
#ifdef XI18N
/*
 * Resource Name for XawTextCode.
 */

#define XtNtextCode     "textCode"
#define XtCTextCode     "TextCode"
#define XtRTextCode     "TextCode"
#endif /* XI18N */
