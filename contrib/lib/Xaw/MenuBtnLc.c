/* $XConsortium: MenuButtonLc.c,v 1.18 91/06/22 18:03:46 rws Exp $ */
...
/*
 * MenuButtonLc.c - Source code for MenuButtonLocale widget.
 *
 * This is the source code for the Athena MenuButtonLocale widget.
...
#define offset(field) XtOffsetOf(MenuButtonLocaleRec, field)
...
MenuButtonLocaleClassRec menuButtonLocaleClassRec = {
  {
    (WidgetClass) superclass,		/* superclass		  */	
    "MenuButtonLocale",			/* class_name		  */
    sizeof(MenuButtonLocaleRec),       	/* size			  */
...
WidgetClass menuButtonLocaleWidgetClass = (WidgetClass) &menuButtonLocaleClassRec;
...
Cardinal * num_params;
{
  MenuButtonLocaleWidget mbw = (MenuButtonLocaleWidget) w;
  Widget menu, temp;
  Arg arglist[2];
  Cardinal num_args;
