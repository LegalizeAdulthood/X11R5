/*
 * $XConsortium: SmeBSBLcP.h,v 1.6 89/12/11 15:20:15 kit Exp $
 *
...
#ifndef _XawSmeBSBLocaleP_h
#define _XawSmeBSBLocaleP_h
...
typedef struct _SmeBSBLocaleClassPart {
  XtPointer extension;
} SmeBSBLocaleClassPart;

/* Full class record declaration */
typedef struct _SmeBSBLocaleClassRec {
    RectObjClassPart       rect_class;
    SmeClassPart     sme_class;
    SmeBSBLocaleClassPart  sme_bsb_class;
} SmeBSBLocaleClassRec;
...
typedef struct _SmeBSBLocaleRec {
  ObjectPart         object;
  RectObjPart        rectangle;
  SmePart	     sme;
  SmeBSBLocalePart   sme_bsb;
} SmeBSBLocaleRec;
