...
EXTERN_FUNCTION (Seln_client selection_create, (Xv_Server server,
void (*func)(Xv_opaque, Seln_function_buffer *),
Seln_request (*r_proc)(int, Seln_replier_data *, int), Xv_opaque client_data));
