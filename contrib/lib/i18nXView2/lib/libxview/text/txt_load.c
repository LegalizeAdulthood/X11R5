#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_load.c 50.8 90/11/04";
#endif
#endif
...
#ifdef OW_I18N
    temp_dir_str = (CHAR  *) xv_get(load_panel_items[(int) DIR_STRING_ITEM],
			      PANEL_VALUE_WCS);
    temp_file_str = (CHAR  *) xv_get(load_panel_items[(int) FILE_STRING_ITEM],
			       PANEL_VALUE_WCS);
    ...
    load_panel_items[(int) FILE_CMD_ITEM] = panel_create_item(panel,
						...
						PANEL_LABEL_X, ATTR_COL(26),
						 PANEL_LABEL_Y, ATTR_ROW(2),
					      PANEL_LABEL_STRING, 
#ifdef OW_I18N
						XV_I18N_MSG("xv_messages", "Load File"),
#else
						load_file,
#endif
