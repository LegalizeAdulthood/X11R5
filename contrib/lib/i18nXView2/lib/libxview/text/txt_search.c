#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_search.c 50.9 90/11/04";
#endif
#endif
...

{
    ...
    STRNCPY(buf, (CHAR  *) panel_get(
				    search_panel_items[(int) FIND_STRING_ITEM], PANEL_VALUE_WCS), MAX_STR_LENGTH);
#else
    STRNCPY(buf, (CHAR  *) panel_get(
    ...
    Textsw_view_handle view;
{
	 ...
	 * strdup call.
	 */
	search		= XV_I18N_MSG("xv_messages", "Find");
	replace		= XV_I18N_MSG("xv_messages", "Replace");
	all		= XV_I18N_MSG("xv_messages", "Replace All");
	search_replace	= XV_I18N_MSG("xv_messages", "Find then Replace");
	replace_search	= XV_I18N_MSG("xv_messages", "Replace then Find");
	backward	= XV_I18N_MSG("xv_messages", "Backward");
	forward		= XV_I18N_MSG("xv_messages", "Forward");
	init_str = 1;
    }
#endif
...
#ifdef OW_I18N
			    XV_I18N_MSG("xv_messages", "All Text"), 
			    XV_I18N_MSG("xv_messages", "To End"), 0,
#else
				"All Text", "To End", 0,
#endif
