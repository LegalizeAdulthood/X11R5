...
typedef enum {
	...
	SERVER_EXTENSION_PROC		= SERVER_ATTR(ATTR_FUNCTION_PTR,260),
	SERVER_META_MOD_MASK		= SERVER_ATTR(ATTR_INT,		265),
#ifdef OW_I18N
        SERVER_RESOURCE_DB              = SERVER_ATTR(ATTR_OPAQUE,      246),
	SERVER_COMPOUND_TEXT		= SERVER_ATTR(ATTR_OPAQUE,      249),
	SERVER_WM_DECOR_IMSTATUS	= SERVER_ATTR(ATTR_OPAQUE,      56),
	SERVER_WM_WINMSG_IMSTATUS	= SERVER_ATTR(ATTR_OPAQUE,      111),
	SERVER_WM_WINMSG_IMPREEDIT	= SERVER_ATTR(ATTR_OPAQUE,      116),
#endif
} Server_attr;
