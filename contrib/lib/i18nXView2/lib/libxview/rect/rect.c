#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)rect.c 50.4 90/11/04 Copyr 1984 Sun Micro";
#endif
#endif
...
#ifdef OW_I18N
	xv_error(NULL,
		 ERROR_STRING, XV_I18N_MSG("xv_messages","Bad sortorder arg in mostRect"),
		 0);
#else
	xv_error(NULL,
		 ERROR_STRING, "Bad sortorder arg in mostRect",
		 0);
#endif OW_I18N
	break;
    }
