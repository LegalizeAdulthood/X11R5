...
#ifdef OW_I18N
	WIN_IM_PREEDIT_START 	= WIN_ATTR(ATTR_INT_PAIR,	 21),
	WIN_IM_PREEDIT_DRAW 	= WIN_ATTR(ATTR_INT_PAIR,	 22),
	WIN_IM_PREEDIT_DONE	= WIN_ATTR(ATTR_INT_PAIR, 	 23),
#endif OW_I18N
	WIN_CONSUME_EVENT	= WIN_ATTR(ATTR_ENUM,		 24),	/* --S */
#ifdef OW_I18N
	WIN_IM_STATUS_START	= WIN_ATTR(ATTR_INT_PAIR,	 25),
	WIN_IM_STATUS_DRAW	= WIN_ATTR(ATTR_INT_PAIR,	 26),
	WIN_IM_STATUS_DONE	= WIN_ATTR(ATTR_INT_PAIR,	 27),
#endif OW_I18N
	WIN_CONSUME_EVENTS	
			= WIN_ATTR_LIST(ATTR_NULL, ATTR_ENUM,	 28),	/* --S */
#ifdef OW_I18N
	WIN_IM_LUC_START	= WIN_ATTR(ATTR_INT_PAIR,	 29),
	WIN_IM_LUC_DRAW		= WIN_ATTR(ATTR_INT_PAIR,	 30),
	WIN_IM_LUC_DONE		= WIN_ATTR(ATTR_INT_PAIR,	 31),
#endif OW_I18N
	WIN_CURSOR		= WIN_ATTR(ATTR_CURSOR_PTR,	 32),
#ifdef OW_I18N
	WIN_IM_LUC_PROCESS	= WIN_ATTR(ATTR_INT_PAIR, 	 33),
#endif OW_I18N
...
#ifdef OW_I18N
        WIN_IC                  = WIN_ATTR(ATTR_OPAQUE,          74),   /* -SG */
        WIN_USE_IM              = WIN_ATTR(ATTR_BOOLEAN,         75),   /* C-G */
#endif
 ...
 */
EXTERN_FUNCTION (Xv_opaque window_create_rect_obj_list, (int num_elems));
EXTERN_FUNCTION (void window_destroy_rect_obj_list, ( Xv_opaque rect_obj_list));
EXTERN_FUNCTION (void window_add_to_rect_list, ( Xv_opaque rect_obj_list, Xv_Window window, Rect *rect, int i));
EXTERN_FUNCTION (int window_rect_equal_ith_obj, ( Xv_opaque rect_obj_list, Rect *rect, int i));
/* 
 * The msg type in window_set_client_message() is actually XClientMessageEvent * 
*/
EXTERN_FUNCTION (void window_set_client_message, ( Xv_Window window, void *msg));
...
EXTERN_FUNCTION (Xv_Window window_create, (Xv_Window window, caddr_t (*c)(), DOTDOTDOT));
...
EXTERN_FUNCTION (void window_rc_units_to_pixels, (Xv_Window win, Window_attribute *attr));
