#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)fs.c 50.4 90/11/04";
#endif
#endif
...
void fullscreen_update_globals();
    ...
    int            *offset_ptr;
{
	...
	xv_error(NULL,
#ifdef	OW_I18N
		 ERROR_STRING, XV_I18N_MSG("xv_messages", "Already in fullscreen mode!"),
#else
		 ERROR_STRING, "Already in fullscreen mode!",
#endif	OW_I18N
    ...
    int	code;
{
    switch (code) {
...
#ifdef	OW_I18N
        return ((char *)
		XV_I18N_MSG("xv_messages", "Already in fullscreen by another client. Fullscreen Failed."));
#else
        return ((char *)
...
#ifdef	OW_I18N
        return ((char *)XV_I18N_MSG("xv_messages", "Invalid time. Fullscreen failed."));
#else
...
#ifdef	OW_I18N
        return ((char *)XV_I18N_MSG("xv_messages", "Fullscreen window or confine-to window not mapped. Fullscreen failed."));
#else
      ...
      case (GrabFrozen):
#ifdef	OW_I18N
        return ((char *)XV_I18N_MSG("xv_messages", "Already frozen by another client. Fullscreen Failed."));
#else
