...
typedef enum {
...
#ifdef OW_I18N
	XV_LABEL_WCS		= GENERIC_ATTR(ATTR_WSTRING,	 160),
	...
	XV_USE_INSTANCE_RESOURCES=XV_ATTR(ATTR_OPAQUE,		140),
        /*
         * Added to support XIM
         */
        XV_IM                   = XV_ATTR(ATTR_OPAQUE,          150), /* --G */
	/*
...
EXTERN_FUNCTION (Xv_object xv_init, (DOTDOTDOT));
