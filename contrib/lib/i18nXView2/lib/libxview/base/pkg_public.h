/*      @(#)pkg_public.h 50.1 90/12/12 SMI      */
...
EXTERN_FUNCTION (Xv_opaque xv_get, (Xv_opaque object, DOTDOTDOT));
...
EXTERN_FUNCTION (Xv_opaque xv_object_to_standard, (Xv_object object, char *caller));

#define XV_OBJECT_SEAL          0xF0A58142
#define XV_OBJECT_TO_STANDARD(_passed_object, _caller, _object)\
{\
      if (!_passed_object) {\
        xv_error(NULL, ERROR_INVALID_OBJECT,"not a pointer",\
