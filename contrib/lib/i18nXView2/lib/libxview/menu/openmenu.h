...
/*--G*/	MENU_TYPE		= MENU_ATTR(ATTR_NO_VALUE,		183), 
	...
	MENU_GEN_PULLRIGHT_ITEM_WCS	= MENU_ATTR(ATTR_STRING_FUNCTION_PAIR,	 58), 
 ...
 * PRIVATE functions 
 */
EXTERN_FUNCTION (Xv_opaque menu_pullright_return_result, (Menu_item item));
EXTERN_FUNCTION (Xv_opaque menu_return_default, (Menu menu, int depth));
