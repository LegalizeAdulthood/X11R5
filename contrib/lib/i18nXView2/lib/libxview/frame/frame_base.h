/*	@(#)frame_base.h 50.4 90/11/10 SMI	*/
...
#ifdef OW_I18N
	BIT_FIELD(show_resize_corner_init);
					/* show resize corner init? */
	BIT_FIELD(show_IMstatus); 	/* show IMstatus or not */
	BIT_FIELD(show_IMstatus_init); 	/* show IMstatus has been init? */
#endif
    } status_bits;
} Frame_base_info;
