/*
 * @(#)win_notify.h 20.11 90/05/02 SMI
 *
...
EXTERN_FUNCTION (Notify_error 	win_post_id, (Notify_client client, short id, Notify_event_type when));
		
EXTERN_FUNCTION (Notify_error 	win_post_id_and_arg, (Notify_client client, short id, Notify_event_type when, Notify_arg arg, Notify_copy copy_func, Notify_release release_func));
