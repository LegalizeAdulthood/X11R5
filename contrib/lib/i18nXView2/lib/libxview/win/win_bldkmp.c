#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)win_bldkmp.c 20.21 90/03/29";
#endif
#endif
...

{
    ...
    xv_map = (unsigned short *) calloc(MAX_KEYCODE_TABLE, sizeof(unsigned short));
...
#endif
    sem_map = (unsigned short *) calloc(MAX_KEYCODE_TABLE, sizeof(unsigned short));
