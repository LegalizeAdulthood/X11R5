#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)tty_ntfy.c 50.7 90/11/04";
#endif
#endif
...
#ifdef OW_I18N
	perror(XV_I18N_MSG("xv_messages", "ttysw_sigwinch, can't get tty process group"));
#else
...
#ifdef OW_I18N
	perror(XV_I18N_MSG("xv_messages", "ioctl"));
#else
	perror("ioctl");
#endif
}
