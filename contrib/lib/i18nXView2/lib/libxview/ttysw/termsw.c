#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)termsw.c 50.10 90/11/27";
#endif
#endif
...
#ifdef OW_I18N		/* Cache the textsw ic before ttysw ic over write it */
    Termsw_folio    termsw_folio = TERMSW_PRIVATE(termsw_public);
    termsw_folio->ic = (XIC)xv_get(termsw_view_public, WIN_IC);    
#endif
...
#ifdef OW_I18N		/* Cache the textsw ic before ttysw ic over write it */
     xv_set(termsw_view_public, WIN_IC, termsw_folio->ic, 0);    
#endif
