...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/messages.c,v 2.42 1991/09/19 17:15:16 rr2b Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/messages.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/messages.c,v 2.42 1991/09/19 17:15:16 rr2b Exp $ ";
#endif /* lint */
...
extern		countdots();
extern		void text_CleanUpGlitches();
...
static struct bind_Description messages_standardbindings [] = {
    ...
    {"messages-duplicate", "\0302", NULL, NULL, NULL, 0, messages_DuplicateWindow, "Open another folders window"},
    ...
    {"messages-cleanup-body", NULL, NULL, "This Message~30,Clean Up Body~32", NULL, MENUMASK_MSGSHOWING, BSM_CleanupBody, "Clean up transport glitches in message body"},
...
void BSM_CleanupBody(self)
struct messages *self;
{
    struct text *t = (struct text *) t822view_GetDataObject(GetBodies(self));

    ams_WaitCursor(TRUE);
    text_CleanUpGlitches(t);
    ams_WaitCursor(FALSE);
}
