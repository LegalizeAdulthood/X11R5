...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/folders.c,v 1.38 1991/10/03 02:22:38 dba Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/folders.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atkams/messages/lib/RCS/folders.c,v 1.38 1991/10/03 02:22:38 dba Exp $ ";
#endif /* lint */
...
struct folders *self;
{
    ...
    if(self->prefs) {
	sbutton_GetFont(self->prefs)=fontdesc_Create("andy", fontdesc_Bold, 12);
