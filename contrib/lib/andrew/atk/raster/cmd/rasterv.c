...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/raster/cmd/RCS/rasterv.c,v 2.36 1991/10/03 01:21:29 gk5g Exp $ */
/* $ACIS:rasterv.c 1.3$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/raster/cmd/RCS/rasterv.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/raster/cmd/RCS/rasterv.c,v 2.36 1991/10/03 01:21:29 gk5g Exp $";
#endif /* lint */
...
enum RasterIOType rock;
{
	...
	mktemp(filename);
	if (rock == MakeWD)
	    sprintf(cmd, "xwd %s -out %s", (rasterview_DisplayClass(self) & graphic_Color) ? "" : "-xy", filename);
	else
...
long width, height;
{
	...
	rasterimage_BlitSubraster(pix, xscr, yscr,
...
/*    bind_BindList(EmbeddedBindings, EmbeddedKeymap, EmbeddedMenus,
    ...
    keymap_BindToKey(EmbeddedKeymap, "\033\022x", proc, 0);
    /* ESC - ^R - x*/
    menulist_AddToML(EmbeddedMenus, "File,Read X Window Dump~13", proc, (long)Inxwd, menuRead);

    proc = proctable_DefineProc("rasterv-read-xbmfile",
				 RasterIOCommand,
				 &rasterview_classinfo, NULL,
				 "Read file in X Bitmap format");
    keymap_BindToKey(EmbeddedKeymap, "\033\022b", proc, 0);
    /* ESC - ^R - b*/
    menulist_AddToML(EmbeddedMenus, "File,Read X Bitmap~14", proc, (long)Inxbm, menuRead);
    ...
    proc = proctable_DefineProc("rasterv-read-xwdfile",
				 ...
				 &rasterview_classinfo, NULL,
				 "Read file in X Window Dump format");
    keymap_BindToKey(ApplicationKeymap, "\033\022x", proc, 0);
    /* ESC - ^R - x*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Read X Window Dump~52", proc, (long)Inxwd, menuRead);
    ...
    keymap_BindToKey(ApplicationKeymap, "\033\022X", proc, 0);
    /* ESC - ^R - X*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Write X Window Dump~54", proc, (long)Outxwd, menuWrite);
...
/* paul's attempt to add X Bitmap I/O : */
    ...
    proc = proctable_DefineProc("rasterv-read-xbmfile",
				 ...
				 &rasterview_classinfo, NULL,
				 "Read file in X Bitmap format");
    keymap_BindToKey(ApplicationKeymap, "\033\022b", proc, 0);
    /* ESC - ^R - b*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Read X Bitmap~62", proc, (long)Inxbm, menuRead);
    ...
    keymap_BindToKey(ApplicationKeymap, "\033\022B", proc, 0);
    /* ESC - ^R - B*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Write X Bitmap~64", proc, (long)Outxbm, menuWrite);
...
/* end of paul's attempt to add X Bitmap I/O : */
    ...
    keymap_BindToKey(ApplicationKeymap, "\033\022Iw", proc, 0);
    /* ESC - ^R - I - w*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Make Window Dump~70", proc, (long)MakeWD, menuRead);
    ...
    proc = proctable_DefineProc("rasterv-make-asnap",
				 ...
				 &rasterview_classinfo, NULL,
				 "Sweep area and read.");
    keymap_BindToKey(ApplicationKeymap, "\033\022Ia", proc, 0);
    /* ESC - ^R - I - a*/
    menulist_AddToML(ApplicationMenus, "Raster I/O~42,Make Area Dump~71", proc, (long)MakeAsnap, menuRead);
#endif
