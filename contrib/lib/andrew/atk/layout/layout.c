...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/layout/RCS/layout.c,v 1.7 1991/09/12 16:23:47 bobg Exp $ */
/* $ACIS$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/layout/RCS/layout.c,v $ */

#ifndef lint
char *layout_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/layout/RCS/layout.c,v 1.7 1991/09/12 16:23:47 bobg Exp $";
#endif /* lint */
	...
	switch(ch) {
		...
		if (havechild) {
		    ...
		    *np = '\0';
		    ...
		    c->data = (struct dataobject *)class_NewObject(dataname);
		    if (cData(c) == NULL) {
