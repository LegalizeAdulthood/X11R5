...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/frame.c,v 2.32 1991/09/18 16:25:18 dba Exp $ */
/* $ACIS:frame.c 1.6$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/frame.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/frame.c,v 2.32 1991/09/18 16:25:18 dba Exp $";
#endif /* lint */
...
static boolean QuitWindowOnlyDefault ;
...
/*	frame_SetFGColor(self,.95,.95,.95); */
	if (self->mono) pct = .75;
	    ...
	    /*	frame_SetFGColor(self,.95,.95,.95); */
	    frame_SetForegroundColor(self,"Dark Gray",0,0,0);
	    return;
	}
    }
    else if(val == 100){
    ...
    struct frame *self;
{
    ...
    frameKeymap = framecmds_InitKeymap(&frameMenus, &frameDefaultMenus);
    ...
    boolean setInputFocus;
{
    ...
    if(buffer == NULL && self->buffer == NULL && self->childView != NULL){
