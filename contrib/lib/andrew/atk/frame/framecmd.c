...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/framecmd.c,v 2.58 1991/09/12 16:21:24 bobg Exp $ */
/* $ACIS:framecmd.c 1.3$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/framecmd.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/frame/RCS/framecmd.c,v 2.58 1991/09/12 16:21:24 bobg Exp $";
#endif /* lint */
    ...
    boolean rawMode;
{
    ...
    return VisitNamedFile(self, filename, newWindow, rawMode);
}

int VisitNamedFile(self, filename, newWindow, rawMode)
    struct frame *self;
    char *filename;
    boolean newWindow;
    boolean rawMode;
...
{
    if (isString(arg))
	return VisitNamedFile(self, arg, newWindow, FALSE);
    else
...
struct keymap *framecmds__InitKeymap(classID, menuOut, menuDefaultOut)
