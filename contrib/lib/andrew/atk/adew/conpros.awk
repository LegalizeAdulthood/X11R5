...
# SOFTWARE.
# 
#  $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/adew/RCS/conpros.awk,v 2.11 1991/09/13 16:12:57 bobg Exp $ 
#  $ACIS: $ 
#  $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/adew/RCS/conpros.awk,v $
BEGIN{
	vcount = 0
