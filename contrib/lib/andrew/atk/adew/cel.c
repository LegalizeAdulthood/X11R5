...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/adew/RCS/cel.c,v 2.18 1991/09/30 17:32:57 tpn Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/adew/RCS/cel.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/adew/RCS/cel.c,v 2.18 1991/09/30 17:32:57 tpn Exp $ ";
#endif /* lint */
...
long value;
{
	...
	cel_NotifyObservers(self,value);
    }
}
