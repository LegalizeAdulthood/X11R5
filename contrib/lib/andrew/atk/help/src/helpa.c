...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpa.c,v 2.47 1991/09/12 16:22:42 bobg Exp $ */
/* $ACIS$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpa.c,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpa.c,v 2.47 1991/09/12 16:22:42 bobg Exp $";
...
struct helpapp *self;
{
...
#endif /* WM_ENV */
#ifdef X11_ENV
    wmHost = (char *) environ_Get("TERM");
    if (wmHost && (!strcmp(wmHost,"wm") || !strcmp(wmHost,"WM")))
	runningLocally = 1;
    else runningLocally = 0;
    wmHost = (char *)malloc(MAXHOSTNAMELEN * sizeof(char));
    gethostname(wmHost, MAXHOSTNAMELEN);
    DEBUG(("ha: wmhost: %s\n",wmHost));
#endif /* X11_ENV */
	...
	if (th != NULL) {
		...
		printf("Sent reqest to existing help window.\n");
		close(helpSocket);
		exit(0);
	    }
	} else
