...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpdb.c,v 1.18 1991/09/12 16:22:57 bobg Exp $ */
/* $ACIS$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpdb.c,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/help/src/RCS/helpdb.c,v 1.18 1991/09/12 16:22:57 bobg Exp $";
...
struct helpFile *tmplist;
{
    ...
    *tfp++ = '/';	/* tfp points just after the last '/' */
	...
	tf->fileName =
	    (char *) malloc(strlen(dname) + 1 + namlen(tde) + 1);
