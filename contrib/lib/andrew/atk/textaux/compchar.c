...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/textaux/RCS/compchar.c,v 1.16 1991/09/12 16:37:27 bobg Exp $ */
/* $ACIS:$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/textaux/RCS/compchar.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/textaux/RCS/compchar.c,v 1.16 1991/09/12 16:37:27 bobg Exp $";
#endif /* lint */
...
char *style;
{
	...
	if(text_ReadTemplate(t,tmpl2,FALSE)) message_DisplayString(tv,99,"Warning: proper template could not be loaded.");
