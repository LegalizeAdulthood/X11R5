...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/value/RCS/valuev.c,v 2.9 1991/09/30 18:26:45 susan Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/value/RCS/valuev.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/value/RCS/valuev.c,v 2.9 1991/09/30 18:26:45 susan Exp $ ";
#endif /* lint */
     ...
     long x,y,width,height;
{
  ...
  if(type != view_MoveNoRedraw) DrawFromScratch(self);
}
#define MAXPAR 36
