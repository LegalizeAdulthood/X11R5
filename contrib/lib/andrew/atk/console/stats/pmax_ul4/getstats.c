...
\* ********************************************************************** */
static char *getstats_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/console/stats/pmax_ul4/RCS/getstats.c,v 1.3 1991/09/12 16:09:10 bobg Exp $";
