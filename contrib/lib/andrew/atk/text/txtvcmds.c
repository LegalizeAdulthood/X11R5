...
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcmds.c,v 2.67 1991/09/12 16:36:42 bobg Exp $ */
/* $ACIS:txtvcmds.c 1.7$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcmds.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcmds.c,v 2.67 1991/09/12 16:36:42 bobg Exp $";
#endif /* lint */
...
static struct bind_Description textviewViCommandModeBindings[]={
   ...
   {"textview-previous-line", "\020",0,NULL,0,0,textview_PreviousLineCmd,"Move to previous line.", NULL},
    ...
    {"dynsearch-search-backward", "?",0,"Search/Spell~1,Backward~11",0,0, NULL, NULL, NULL},
