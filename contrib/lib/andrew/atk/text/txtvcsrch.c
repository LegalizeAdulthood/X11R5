...
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcsrch.c,v 1.4 1991/09/12 16:37:13 bobg Exp $ */
/* $ACIS:txtvcsrch.c 1.7$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcsrch.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/text/RCS/txtvcsrch.c,v 1.4 1991/09/12 16:37:13 bobg Exp $";
#endif /* lint */
...
long pos;
{
    ...
    do
    {
	if ( (parentype = index(closeTable, text_GetChar(doc, pos))) != NULL )
	{
	...
	else if ((parentype = index(openTable, text_GetChar(doc, pos))) != NULL )
	{
...
struct textview *self;
{
	...
	if ( (pos =  skipToNextBalanceSymbol(doc, pos - 1, FORWARD)) == EOF )
	    break;
	if ( index(balanceSymbols, text_GetChar(doc, pos)) - balanceSymbols > 2 )
	{
