...
\* ********************************************************************** */
static char *chartp_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/chart/RCS/chartp.c,v 1.9 1991/09/12 16:05:03 bobg Exp $";


#ifndef lint
static char *rcsidchartp = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/chart/RCS/chartp.c,v 1.9 1991/09/12 16:05:03 bobg Exp $";
#endif
...
suite_Specification		  palette_item1[] =
  {
  suite_ItemDatum( palette_item1_code ),
  NULL
  };

suite_Specification		  palette_item2[] =
  {
  suite_ItemDatum( palette_item2_code ),
  NULL
  };

suite_Specification		  palette_item3[] =
  {
  suite_ItemDatum( palette_item3_code ),
  NULL
  };

suite_Specification		  palette_item4[] =
  {
  suite_ItemDatum( palette_item4_code ),
  NULL
  };

suite_Specification		  palette_suite[] =
  {
  suite_Arrangement( suite_Matrix ),
...
suite_Specification		  sort_item1[] =
  {
  suite_ItemDatum( sort_item1_code ),
  NULL
  };

suite_Specification		  sort_item2[] =
  {
  suite_ItemDatum( sort_item2_code ),
  NULL
  };

suite_Specification		  sort_item3[] =
  {
  suite_ItemDatum( sort_item3_code ),
  NULL
  };

suite_Specification		  sort_suite[] =
  {
