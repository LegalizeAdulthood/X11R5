...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/oscroll.ch,v 2.13 1991/10/03 16:07:13 bobg Exp $ */
/* $ACIS:oscroll.ch 1.2$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/oscroll.ch,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsidoscroll_H = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/oscroll.ch,v 2.13 1991/10/03 16:07:13 bobg Exp $";
...
#define TD_FGPAT(self)	(graphic_GrayPattern(((&(self)->header.view))->drawable,TD_FGPATVAL,16))
#define TD_BGPAT(self)	(graphic_GrayPattern(((&(self)->header.view))->drawable,TD_BGPATVAL,16))
#define TD_BACKPAT(self) (graphic_GrayPattern(((&(self)->header.view))->drawable,TD_BACKPATVAL,16))
