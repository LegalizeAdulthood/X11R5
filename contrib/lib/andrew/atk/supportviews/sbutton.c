...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/sbutton.c,v 1.5 1991/09/26 20:37:27 rr2b Exp $ */
/* $ACIS:sbutton.c 1.6$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/sbutton.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/supportviews/RCS/sbutton.c,v 1.5 1991/09/26 20:37:27 rr2b Exp $";
#endif /* lint */
...
static boolean EnsureSize(self, ind)
struct sbutton *self;
int ind;
{
...
char *name;
{
	...
	if(value != NULL) prefs->colors[i] = value;
    }
...
struct sbutton *self;
{
    ...
    if(!EnsureSize(self, 0)) return FALSE;
...
FILE *fp;
{
    ...
    j=0;
    while(--i>=0) {
	if(self->buttons[i].prefs->writeid<0) {
...
struct sbutton_prefs *prefs;
{
    if(!EnsureSize(self, ind) || prefs==NULL) return;
