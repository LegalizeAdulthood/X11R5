static char *contimer_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/examples/atkbook/con/RCS/contimer.c,v 1.3 1991/09/12 16:13:11 bobg Exp $";
