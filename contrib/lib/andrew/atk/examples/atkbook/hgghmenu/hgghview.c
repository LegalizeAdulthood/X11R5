static char *hgghview_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/examples/atkbook/hgghmenu/RCS/hgghview.c,v 1.3 1991/09/12 16:15:10 bobg Exp $";
