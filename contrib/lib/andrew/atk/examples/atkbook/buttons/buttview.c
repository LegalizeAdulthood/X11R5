static char *buttview_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/examples/atkbook/buttons/RCS/buttview.c,v 1.4 1991/09/12 16:12:49 bobg Exp $";
