static char *flexview_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/examples/atkbook/flex/RCS/flexview.c,v 1.3 1991/09/12 16:14:15 bobg Exp $";
