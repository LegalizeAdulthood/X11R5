static char *switview_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/examples/atkbook/switcher/RCS/switview.c,v 1.4 1991/09/12 16:16:19 bobg Exp $";
