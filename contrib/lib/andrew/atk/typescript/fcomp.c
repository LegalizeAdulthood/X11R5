...
\* ********************************************************************** */
static char *fcomp_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/typescript/RCS/fcomp.c,v 1.18 1991/09/12 16:38:09 bobg Exp $";
...
long key;
{
	...
	windowwidth = typescript_GetVisualWidth(ts);
...
boolean forward;
{
    ...
    char *patcode;
    long tlen = text_GetLength(theText);
    long clen = text_GetLength(ts->cmdText);
    long c;
    long tokenLen;
