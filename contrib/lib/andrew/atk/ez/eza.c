...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/ez/RCS/eza.c,v 2.14 1990/12/14 15:05:57 ajp Exp $ */
/* $ACIS:eza.c 1.5$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/ez/RCS/eza.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/atk/ez/RCS/eza.c,v 2.14 1990/12/14 15:05:57 ajp Exp $";
#endif /* lint */
        ...
        do {
            ...
            switch (errno) {
                ...
                case 0: /* Message line was punted. */
                    ...
                    break;
                default:
                    message_DisplayString(frame, 0, "File could not be created. Press any key to continue.");
            }
