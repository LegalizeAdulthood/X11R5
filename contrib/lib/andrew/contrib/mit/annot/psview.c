...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/contrib/mit/annot/RCS/psview.c,v 1.10 1991/09/25 23:38:41 mcinerny Exp $ */
/* $ACIS:$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/contrib/mit/annot/RCS/psview.c,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
	char *sketch_ch_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/contrib/mit/annot/RCS/psview.c,v 1.10 1991/09/25 23:38:41 mcinerny Exp $";
     ...
     struct psview *self;
{
    ...
    if (!(self->interpret)) return;

    {    /* BUG:  graphic should have a method to do this.... */
	...
	xgr = (struct xgraphic *)psview_GetDrawable(self);
