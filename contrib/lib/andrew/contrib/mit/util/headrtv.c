...
\* ********************************************************************** */
static char *headrtv_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/contrib/mit/util/RCS/headrtv.c,v 1.3 1991/09/12 16:52:46 bobg Exp $";
...
{
    while(self) {
	if(!strcmp(class_GetTypeName(self),"textview")) return (struct textview *)self;
	self=self->parent;
    }
