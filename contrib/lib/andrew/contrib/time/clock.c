...
\* ********************************************************************** */
static char *clock_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/contrib/time/RCS/clock.c,v 1.3 1991/09/12 20:43:21 mcinerny Exp $";
...
*/
  if (self->ev) event_Cancel(self->ev);
