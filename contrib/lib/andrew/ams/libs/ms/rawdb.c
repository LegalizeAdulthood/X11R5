...
\* ********************************************************************** */
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/rawdb.c,v 2.57 1991/09/12 15:47:03 bobg Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/rawdb.c,v $
*/
/*
        rawdb.c -- Routines for accessing MS database files in the raw.
*/

char            ams_rawdb_rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/rawdb.c,v 2.57 1991/09/12 15:47:03 bobg Exp $";
...
extern char    *index(), *rindex(), *permanentmalloc();
extern long     time();
...
char           *p1, *p2;
{
    ...
    elt1start = index(p1, '/');        /* Assuming slashes, not dots; hope
                                        * that's OK */
    elt2start = index(p2, '/');
