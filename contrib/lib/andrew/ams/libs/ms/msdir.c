/* ********************************************************************** *\
  ...
  *        For full copyright information see:'andrew/config/COPYRITE'     *
  \* ********************************************************************** */
/*
  $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msdir.c,v 2.35 1991/09/12 15:45:24 bobg Exp $
  $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msdir.c,v $
  */
/*
  msdir.c -- Routines for manipulating message directory structures
      */

char            ams_msdir_rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msdir.c,v 2.35 1991/09/12 15:45:24 bobg Exp $";
...
extern char    *permanentmalloc(), *index();
