...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/mswp.c,v 2.51 1991/09/12 15:45:47 bobg Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/mswp.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/mswp.c,v 2.51 1991/09/12 15:45:47 bobg Exp $ ";
#endif /* lint */
...
{/* Do the White Pages lookup here; result in the Addr structure and MSWP_code to WpCode. */
    ...
    wp_ErrorCode wpErr;
    wp_PrimeKeySet *PKs;
    int MinMatch, OutMatch, size, i, code, WasFuzzy, UsePlus;
	...
	*WpCode = WasFuzzy ? MSWP_PROBABLYFUZZYAMBIG : MSWP_AMBIGWITHERRORS;
	...
	if (CanonName != NULL && NameSep > 0) {
		...
		*WpCode = MSWP_TEMPFAIL;
		...
		for (; *CPtr != '\0'; ++CPtr)
		    if (*CPtr == ' ') *CPtr = '_';
	    strcat(CommText, (CanonID && CheckAMSUseridPlusWorks(Domain) > 0) ? "+@" : "@");
