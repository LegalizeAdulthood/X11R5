...
\* ********************************************************************** */
static char *msprint_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msprint.c,v 2.25 1991/09/12 15:45:38 bobg Exp $";

/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msprint.c,v 2.25 1991/09/12 15:45:38 bobg Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/msprint.c,v $
*/
#include <ms.h>
#include <errprntf.h>
#include <hdrparse.h>
...
extern char *StripWhiteEnds(), *index(), *rindex(), *getenv();
extern double getla();
