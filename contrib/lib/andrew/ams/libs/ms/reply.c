...
\* ********************************************************************** */
static char *reply_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/reply.c,v 2.13 1991/09/12 15:47:52 bobg Exp $";

/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/reply.c,v 2.13 1991/09/12 15:47:52 bobg Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/ms/RCS/reply.c,v $
*/
...
int hdrlen;
{
	...
	if ((hdr = getprofile("fwdheaders")) != NULL) {
	    ...
	    fwdhdrs = (char **)malloc((2+numhdrs) * sizeof(char *));
	    t = malloc(1+strlen(hdr));
