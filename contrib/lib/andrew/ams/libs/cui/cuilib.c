...
\* ********************************************************************** */
static char *cuilib_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/cui/RCS/cuilib.c,v 2.49 1991/09/12 18:54:10 mcinerny Exp $";

/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/cui/RCS/cuilib.c,v 2.49 1991/09/12 18:54:10 mcinerny Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/libs/cui/RCS/cuilib.c,v $
*/
...
char *Tolist;
{
	...
	if (external == formatct) {
	    ...
	    FormatFlag = AMS_SEND_UNFORMATTED;
            ...
            ExtVec[4] = CUI_UseAmsDelivery ? "Trust the delivery system to remove it as needed" : NULL;
