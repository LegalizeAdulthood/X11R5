...
\* ********************************************************************** */
static char *readalias_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/utils/dlistc/RCS/readalias.c,v 1.4 1991/09/12 15:53:50 bobg Exp $";
