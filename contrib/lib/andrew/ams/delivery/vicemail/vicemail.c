...
\* ********************************************************************** */
static char *vicemail_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/delivery/vicemail/RCS/vicemail.c,v 1.12 1991/09/12 15:40:22 bobg Exp $";
