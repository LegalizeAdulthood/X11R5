...
\* ********************************************************************** */
static char *queuem_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/delivery/queuem/RCS/queuem.c,v 1.73 1991/09/12 15:39:22 bobg Exp $";
