...
\* ********************************************************************** */
static char *deliver_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/ams/delivery/queuem/RCS/deliver.c,v 1.11 1991/09/12 15:17:03 bobg Exp $";
