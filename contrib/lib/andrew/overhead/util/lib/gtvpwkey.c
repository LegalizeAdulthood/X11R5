...
\* ************************************************************ */
static char RCSid[]="$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/overhead/util/lib/RCS/gtvpwkey.c,v 2.11 1991/09/12 17:27:06 bobg Exp $";
...
#if (! defined(SYSV) && ! defined(AIX) && ! defined(POSIX_ENV))
