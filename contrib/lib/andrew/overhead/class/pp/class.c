...
\* ********************************************************************** */
static char *class_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/overhead/class/pp/RCS/class.c,v 2.43 1991/09/12 17:08:33 bobg Exp $";

/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R5/ftp/src/overhead/class/pp/RCS/class.c,v 2.43 1991/09/12 17:08:33 bobg Exp $ */
 ...
 **/
static errorhandler(sig, code, scp)
int sig;
int code;
 ...
 */
	...
	(void) fprintf(importfile, "    (*((struct %s * (*)(%s)) (%s_classheader.classprocedures->routines[0])))(&%s_classheader,%s_VERSION)\n", FinalClassName, proto, FinalClassName, FinalClassName, FinalClassName);
	...
	(void) fprintf(importfile, "    (*((void (*)(%s)) (%s_classheader.classprocedures->routines[2])))(&%s_classheader,self, %s_VERSION)\n", proto, FinalClassName, FinalClassName, FinalClassName);
	...
	(void) fprintf(importfile, "    (*((void (*)(%s)) (%s_classheader.classprocedures->routines[3])))(&%s_classheader,self)\n", proto, FinalClassName, FinalClassName);
	...
	if (mp->type==ptype_classproc && mp->defined)  {
	    ...
	    if (mp->argcount != 0)
		(void) fprintf(importfile, "    (*((%s (*)(%s)) (%s_classheader.classprocedures->routines[%d])))(&%s_classheader,%s)\n", mp->methodtype, proto, FinalClassName, mp->index, FinalClassName, mp->methodargs);
	    else
		(void) fprintf(importfile, "    (*((%s (*)(%s)) (%s_classheader.classprocedures->routines[%d])))(&%s_classheader)\n", mp->methodtype, proto, FinalClassName, mp->index, FinalClassName);
	    if (mp->argcount != 0)
 ...
 */
	...
	if (usePrototypes) {
	    ...
	    (void) fprintf(exportfile, "    if(!(*((boolean (*)(%s)) (%s_classheader.classprocedures->routines[2])))(&%s_classheader,self, %s_VERSION))\n", proto, FinalParentName, FinalParentName, FinalParentName);
		...
		(void) fprintf(exportfile, "\t(*((void (*)(%s)) (%s_classheader.classprocedures->routines[3])))(&%s_classheader,self);\n", proto, FinalParentName, FinalParentName);
	    }
	    (void) fprintf(exportfile, "\treturn FALSE;\n    }\n");
	}
