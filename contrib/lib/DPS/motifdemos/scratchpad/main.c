    ...
    int wcount;
{
    ...
    XtAddCallback(text, XmNvalueChangedCallback, UpdateTextRegion, NULL);

    XtAddCallback(printerButton, XmNvalueChangedCallback, 
          ChangePrinterOutput, text);
    XtAddCallback(fileButton, XmNvalueChangedCallback,
          ChangePrinterOutput, text);

    XtAddCallback(selectionBox, XmNokCallback, PopdownDialog, printDialog);
    XtAddCallback(selectionBox, XmNokCallback, PrintPage, printerButton);
    XtAddCallback(selectionBox, XmNcancelCallback, PopdownDialog, printDialog);
    ...
    int wcount;
{
    ...
    XtAddCallback(dialog, XmNokCallback, Exit, 0);
    XtAddCallback(button, XmNactivateCallback, PopupDialog, dialog);
    ...
    XtAddCallback(dialog, XmNokCallback, PopdownDialog, dialog);
    XtAddCallback(dialog, XmNokCallback, LoadAIFile, 0);
    XtAddCallback(dialog, XmNcancelCallback, PopdownDialog, dialog);
