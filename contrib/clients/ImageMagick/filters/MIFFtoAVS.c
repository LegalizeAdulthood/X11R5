  ...
  *message;
{
  ...
  (void) fprintf(stderr,"Usage: %s image.miff image.avs\n\n",application_name);
  (void) fprintf(stderr,"Specify 'image.miff' as '-' for standard input.\n");
  (void) fprintf(stderr,"Specify 'image.avs' as '-' for standard output.\n");
  exit(1);
}

/*
  ...
  *image;
{
  ...
  */
  ...
  avs_pixels=(unsigned char *) malloc(image->columns*image->rows*4);
