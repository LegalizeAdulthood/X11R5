...
#define RMT_EQUAL_RGB  1
  ...
  */
  ...
  /*
    Read AVS image.
  */
  (void) ReadData((char *) &avs_header,1,sizeof(Rasterfile),image->file);
  avs_pixels=(unsigned char *) 
    malloc((unsigned int) avs_header.width*avs_header.height*4);
  ...
  *message;
{
  ...
  (void) fprintf(stderr,"Usage: %s [-scene #] image.avs image.miff\n\n",
    application_name);
  (void) fprintf(stderr,"Specify 'image.avs' as '-' for standard input. \n");
