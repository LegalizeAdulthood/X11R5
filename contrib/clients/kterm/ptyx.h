 ...
 *	$Id: ptyx.h,v 5.0 1991/10/05 08:27:08 kagotani Rel $
 */
#include "kterm.h"
...
#ifdef KTERM_COLOR
#define	ATTRIBUTES	0x1e7	/* mask: user-visible attributes */
#else /* !KTERM_COLOR */
...
#ifdef KTERM_COLOR
#define COLORMASK	0x1e0
#define COLOR(c)	(c+1 << 5)
#define COLORNUM(f)	(((f & COLORMASK) >> 5) - 1)
				/* 0x20 to 0x100 indicate the characters are
				 * colored.
				 */
#endif /* KTERM_COLOR */
/* global flags */
...
#ifdef KTERM_KANJI
#define	EUC_KANJI	0x40000	/* true if in EUC mode */
#define	SJIS_KANJI	0x80000	/* true if in SJIS mode */
#endif /* KTERM_KANJI */
