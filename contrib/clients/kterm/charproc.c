 ...
 * $Id: charproc.c,v 5.0 1991/10/05 08:27:08 kagotani Rel $
 */
		 ...
		 case CASE_SGR:
			...
			for (row=0; row<nparam; ++row) {
				switch (param[row]) {
				 ...
				 case 36:
				 case 37:
					term->flags &= ~(COLORMASK|INVERSE);
					term->flags |= COLOR(param[row]-30);
					break;
				 case 40:
				 case 41:
				 case 42:
				 ...
				 case 46:
				 case 47:
					term->flags &= ~COLORMASK;
					term->flags |= COLOR(param[row]-40)|INVERSE;
					break;
#endif /* KTERM_COLOR */
				}
			}
