/* $Id: charproc.c,v 1.4 1991/10/07 19:24:08 ygz Exp $ */
/***********************************************************************
 ...
 * It would be longer than 1024 bytes.  :-(	-ygz
 */
...
#ifdef HANZI
   new->screen.hzIwin.it_dirs = request->screen.hzIwin.it_dirs;
...
*/
	...
	RealizeHZInputArea (term);	/* do resize */
#endif /* HANZI */
