...
{ "-hm method_name",       "starting input mode, default is ASCII" },
{ "-hz encoding",          "use Hanzi encoding: GB or BIG5" },
 ...
 */
	...
	if(debug)
#ifdef HANZI
		i = open ("cxterm.debug.log", O_WRONLY | O_CREAT | O_TRUNC,
		 0666);
#else  /* HANZI */
