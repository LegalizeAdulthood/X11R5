...
*
* File:         wc_PushB.c
* RCS:          $Header: wc_PushB.c,v 1.3 91/03/14 03:14:57 mayer Exp $
* Description:  XM_PUSH_BUTTON_WIDGET_CLASS/XM_PUSH_BUTTON_GADGET_CLASS
* Author:       Niels Mayer, HPLabs
* Created:      Sat Oct 28 04:22:22 1989
* Modified:     Thu Oct  3 23:40:32 1991 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: wc_PushB.c,v 1.3 91/03/14 03:14:57 mayer Exp $";
 ...
 ******************************************************************************/
static void Lexical_Bindings_For_XmPushButtonCallbackStruct(bindings_list, lexical_env, cd, o_widget)
     ...
     LVAL o_widget;		/* XLTYPE_WIDGETOBJ */
{
  ...
  for ( ; consp(bindings_list); bindings_list = cdr(bindings_list)) {
    ...
    if (s_bindname == s_CALLBACK_WIDGET) {
      ...
      sprintf(temptext,
	      "Unknown binding name in XmPushButtonCallbackStruct callback evaluator. Valid symbols are [%s %s %s %s].",
