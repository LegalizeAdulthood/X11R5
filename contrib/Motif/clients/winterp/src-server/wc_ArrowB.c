...
*
* File:         wc_ArrowB.c
* RCS:          $Header: wc_ArrowB.c,v 1.3 91/03/14 03:14:25 mayer Exp $
* Description:  XM_ARROW_BUTTON_WIDGET_CLASS/XM_ARROW_BUTTON_GADGET_CLASS
* Author:       Niels Mayer, HPLabs
* Created:      Fri Oct 27 21:36:45 1989
* Modified:     Thu Oct  3 23:57:05 1991 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: wc_ArrowB.c,v 1.3 91/03/14 03:14:25 mayer Exp $";
 ...
 ******************************************************************************/
static void Lexical_Bindings_For_XmArrowButtonCallbackStruct(bindings_list, lexical_env, cd, o_widget)
...
{
  extern LVAL s_CALLBACK_WIDGET, s_CALLBACK_REASON, s_CALLBACK_XEVENT, s_CALLBACK_CLICK_COUNT; /* w_callbacks.c */
  ...
  for ( ; consp(bindings_list); bindings_list = cdr(bindings_list)) {
    ...
    if (s_bindname == s_CALLBACK_WIDGET) {
      ...
      sprintf(temptext,
	      "Unknown binding name in XmArrowButtonCallbackStruct callback evaluator. Valid symbols are [%s %s %s %s].",
