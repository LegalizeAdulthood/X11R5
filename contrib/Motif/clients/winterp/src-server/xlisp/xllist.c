...
*
* File:         xllist.c
* RCS:          $Header: xllist.c,v 1.4 91/03/24 22:25:09 mayer Exp $
* Description:  xlisp built-in list functions
* Author:       David Michael Betz
* Created:      
* Modified:     Fri Oct  4 04:05:52 1991 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xllist.c,v 1.4 91/03/24 22:25:09 mayer Exp $";
...
LOCAL FORWARD LVAL subst(),sublis(),map(); /* NPM: changed this to LOCAL */
