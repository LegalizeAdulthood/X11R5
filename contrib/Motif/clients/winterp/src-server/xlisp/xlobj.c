...
*
* File:         xlobj.c
* RCS:          $Header: xlobj.c,v 1.5 91/03/24 22:25:15 mayer Exp $
* Description:  xlisp object functions
* Author:       David Michael Betz
* Created:      
* Modified:     Fri Oct  4 04:07:16 1991 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xlobj.c,v 1.5 91/03/24 22:25:15 mayer Exp $";
  ...
  LVAL obj,msgcls,method;
{
    ...
    xlenv = cons(cons(obj,msgcls),getenvt(method));
#else
