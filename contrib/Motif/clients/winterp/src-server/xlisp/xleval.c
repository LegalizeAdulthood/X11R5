...
*
* File:         xleval.c
* RCS:          $Header: xleval.c,v 1.5 91/03/24 22:24:36 mayer Exp $
* Description:  xlisp evaluator
* Author:       David Michael Betz
* Created:      
* Modified:     Fri Oct  4 03:51:24 1991 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xleval.c,v 1.5 91/03/24 22:24:36 mayer Exp $";
