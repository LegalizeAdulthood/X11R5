...
typedef struct {
    ...
    Pixmap      	gray_pixmap;
    GC          	normal_GC;
    GC			kanji_normal_GC;	/* Kanji State NEC #R0208 */
    GC			kana_normal_GC;		/* Kanji State NEC #R0209 */
    GC          	inverse_GC;
    GC          	kanji_inverse_GC; 	/* Kanji State NEC #R0210 */
    GC          	kana_inverse_GC;	/* Kanji State NEC #R0211 */
    Boolean     	set;
