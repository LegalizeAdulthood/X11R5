...
#define NORMAL 		0		/* Kanji State NEC #R0242 */
#define REVERSE 	1		/* Kanji State NEC #R0243 */
#define MARK 		2		/* Kanji State NEC #R0244 */
...
typedef struct _TextPart {
    ...
    struct _Kanji_Info {                /* Kanji State NEC #R0245 */
        XawTextPosition  beforeInsertPos;
        int             beforeLength;
        XawTextPosition  rev_start;
        XawTextPosition  rev_end;
        XawTextPosition  mark_start;
        XawTextPosition  mark_end;
        Widget          imode;
        Widget          draw_str;
	unsigned char	*mode_str;
        Boolean         mode_display;
        Boolean         incomplete;
        Boolean         mode_mapping;
    } ki;
} TextPart;
