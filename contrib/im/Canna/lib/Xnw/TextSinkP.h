...
typedef struct {
    ...
    XFontStruct	*kanji_font;		/* Kanji State NEC #R0247 */
    XFontStruct	*kana_font;		/* Kanji State NEC #R0248 */
    Pixel foreground;		/* Foreground color. */
    Pixel background;		/* Background color. */
    Boolean magician;
    Pixel magical_foreground;	/* Kana-Kanji Foreground color. */
    Pixel magical_background;	/* Kana-Kanji Background color. */
    ...
    int      max_ascent,
	     max_descent;		/* Kanji State NEC #R0249 */
