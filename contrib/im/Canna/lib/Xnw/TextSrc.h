...
#include "Xnw.h"			/* Kanji State NEC #R0250 */
...
/* Kanji State NEC #R0251 */
typedef enum {XawstPositions, XawstCharacter, XawstWhiteSpace, XawstEOL,
		XawstParagraph, XawstAll} XawTextScanType;
