...
static XtResource resources[] = {
  ...
  {XtNmagician, XtCMagician, XtRBoolean, sizeof(Boolean),
     offset(magician), XtRImmediate, (caddr_t) False},
  {XtNmagicalForeground, XtCForeground, XtRPixel, sizeof (Pixel),
     offset(magical_foreground), XtRString, XtDefaultForeground}, 
  {XtNmagicalBackground, XtCBackground, XtRPixel, sizeof (Pixel),
     offset(magical_background), XtRString, XtDefaultBackground}, 
};
#undef offset
...
Widget request, new;
{
  ...
  sink->text_sink.max_ascent = XnwMax3(sink->text_sink.font->ascent,
                                       sink->text_sink.kanji_font->ascent,
                                       sink->text_sink.kana_font->ascent);
  sink->text_sink.max_descent = XnwMax3(sink->text_sink.font->descent,
                                        sink->text_sink.kanji_font->descent,
                                        sink->text_sink.kana_font->descent);
}
...
Dimension height;
{
  ...
  font_height = sink->text_sink.max_ascent + sink->text_sink.max_descent;
...
int lines;
{
  ...
  return(lines * (sink->text_sink.max_ascent +
