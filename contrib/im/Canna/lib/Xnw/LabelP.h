...
typedef struct {
    ...
    Pixel	foreground;
    XFontStruct	*font;
    XFontStruct	*kanji_font;		/* Kanji State NEC #R0213 */
    XFontStruct	*kana_font;		/* Kanji State NEC #R0214 */
    char	*label;
    XtJustify	justify;
    ...
    /* private state */
    GC		normal_GC;
    GC		kanji_normal_GC;	/* Kanji State NEC #R0215 */
    GC		kana_normal_GC;		/* Kanji State NEC #R0216 */
    GC          gray_GC;
    GC          kanji_gray_GC;		/* Kanji State NEC #R0217 */
    GC          kana_gray_GC;		/* Kanji State NEC #R0218 */
    Pixmap	stipple;
    Position	label_x;
    Position	label_y;
    ...
    int		max_ascent, max_descent;/* Kanji State NEC #R0219 */
} LabelPart;
