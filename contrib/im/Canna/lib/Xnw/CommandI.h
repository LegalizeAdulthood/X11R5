...
/* Kanji State NEC #R0207 */
#define ComWkanjiFont                    cbw->label.kanji_font
#define ComWkanaFont                     cbw->label.kana_font
#define ComWkanjiLabelGC                 cbw->label.kanji_normal_GC
#define ComWkanaLabelGC                  cbw->label.kana_normal_GC
#define ComWkanjiNormalGC                cbw->command.kanji_normal_GC
#define ComWkanaNormalGC                 cbw->command.kana_normal_GC
#define ComWkanjiGrayGC                  cbw->label.kanji_gray_GC
#define ComWkanaGrayGC                   cbw->label.kana_gray_GC
#define ComWkanjiInverseGC               cbw->command.kanji_inverse_GC
#define ComWkanaInverseGC                cbw->command.kana_inverse_GC
