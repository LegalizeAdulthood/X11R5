...
typedef struct {
    ...
    XFontStruct	*font;
    XFontStruct	*kanji_font;		/* Kanji State NEC #R0221 */
    XFontStruct	*kana_font;		/* Kanji State NEC #R0222 */
    String *    list;
    ...
    GC		kanji_normgc;		/* Kanji State NEC #R0223 */
    GC		kana_normgc;		/* Kanji State NEC #R0224 */
    GC          revgc;
    GC          kanji_revgc;		/* Kanji State NEC #R0225 */
    GC          kana_revgc;		/* Kanji State NEC #R0226 */
    GC          graygc;		/* used when inactive. */
    GC          kanji_graygc;		/* Kanji State NEC #R0227 */
    GC          kana_graygc;		/* Kanji State NEC #R0228 */
    int 	max_ascent,
		max_descent;		/* Kanji State NEC #R0229 */
