...
typedef struct {
    ...
    XFontStruct * kanji_font;		/* Kanji State NEC #R0231 */
    XFontStruct * kana_font;		/* Kanji State NEC #R0232 */
...
/* private resources. */
    ...
    GC kanji_norm_gc;			/* Kanji State NEC #R0233 */
    GC kana_norm_gc;			/* Kanji State NEC #R0234 */
    GC rev_gc;			/* reverse color gc. */
    GC kanji_rev_gc;			/* Kanji State NEC #R0235 */
    GC kana_rev_gc;			/* Kanji State NEC #R0236 */
    GC norm_gray_gc;		/* Normal color (grayed out) gc. */
    GC kanji_norm_gray_gc;		/* Kanji State NEC #R0237 */
    GC kana_norm_gray_gc;		/* Kanji State NEC #R0238 */
    GC invert_gc;		/* gc for flipping colors. */
    GC kanji_invert_gc;			/* Kanji State NEC #R0239 */
    GC kana_invert_gc;			/* Kanji State NEC #R0240 */
