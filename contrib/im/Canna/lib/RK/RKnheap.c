 ...
 */
#ifndef lint
static char rcsid[]="@(#) 102.1 $Header: /work/nk.R3.1/lib/RK/RCS/RKnheap.c,v 1.2 91/05/21 18:59:32 mako Exp $";
#endif
/*LINTLIBRARY*/
 ...
 *	unit ga siyousareteireba, SX.ham no taiou suru bit ga 1 to naru
 *	SX.ham
 *	SX.maxham
 */
/* Hpool
...
/* mask table
 *	SX.ham no kousinn ni riyou saretu teisuu
 */
...
/* _RkHset
 *	[s, e) kan ni taiou suru SX.ham wo siyouchuu to suru
 */
static
int	_RkHset(s, e)
unsigned char	 *s, *e;
...
/* _RkHclr
 *	[s, e) kan ni taiou suru SX.ham wo kaihou suru
 */
static
int	_RkHclr(s, e)
unsigned char	 *s, *e;
