...
static char onoffmap_id[] = "@(#) 102.1 $Header: /work/nk.R3.1/lib/iroha/RCS/onoffmap.c,v 3.1 91/09/02 14:04:04 kon Exp $";
...
extern  IchiranEndOfKouho(), IchiranQuit();

#define NONE IROHA_FN_Undefined

static int (*onoff_funcs[])() = {
/* 未定義                           */    NONE,
/* 自分自身を挿入する関数           */    NONE,
/* 修飾しながら挿入する関数         */    NONE,
/* 引用挿入			    */    NONE,
