...
static	char	rcs_id[] = "@(#) 102.1 $Header: /work/nk.R3.1/cmd/icustom/RCS/set.c,v 1.12 91/09/06 13:07:12 hata Exp $";
...
{
  unsigned char *p;
  p = (unsigned char *)malloc(strlen(acts) + 1);
  strcpy(p, acts);
  return (char *)p;
}
