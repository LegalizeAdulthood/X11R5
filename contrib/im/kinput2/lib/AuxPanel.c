#ifndef lint
static char *rcsid = "$Id: AuxPanel.c,v 1.16 91/09/13 17:13:54 kon Exp $";
#endif
/*
...
Dimension *height_inout;
{
    ...
    for (i = 0 ; i < cpw->cpanel.numauxsegments ; i++, dseg++) {
      minwidth += CDStringWidth(cpw->cpanel.displayobj, dseg, 0, -1);
    }
...
Cardinal n;
{
  ...
  if (cpw->cpanel.dispauxsegments == NULL) {
    ...
    bzero(cpw->cpanel.dispauxsegments + cpw->cpanel.numauxsegments,
...
AuxPanelWidget cpw;
{
  ...
  XtFree(cpw->cpanel.dispauxsegments);
