#ifndef lint
static char *rcsid = "$Id: WcharDisp.c,v 1.16 1991/10/04 01:05:45 ishisone Rel $";
#endif
/*
...
#define UNDERLINED	2
	...
	XDrawLine(dpy, win, obj->wcharDisplay.gc_normal,
		  x, y + obj->wcharDisplay.ascent + 1,
		  x + width - 1, y + obj->wcharDisplay.ascent + 1);
...
static WDCharSet jpCharSet[] = {
    ...
    { "JISX0208.1976-0",	G1LCharSet },
    { "JISX0208.1983-1",	G1RCharSet },
    { "JISX0208.1976-1",	G1RCharSet },
};
