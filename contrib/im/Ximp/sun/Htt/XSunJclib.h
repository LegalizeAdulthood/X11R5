...
/*
 *	jclib.h -- jclib $BMQ%X4@00:19:22!%$%k(J (Wnn Version4 $BBP1~HG(J)
 *		version 4.0
 *		ishisone@sra.co.jp
 */
...
#define JE_CANTDELETE		4	/* $B/home/sundae4/donation/si/SCCS_DIRECTORIES/usr.lib/libxim/SCCS/s.XSunJclib.hC00:19:22!$N@hF,$NA0!"$"$k$$$O(J
...
#define JE_CANTMOVE		10	/* $B/home/sundae4/donation/si/SCCS_DIRECTORIES/usr.lib/libxim/SCCS/s.XSunJclib.hC00:19:22!$N@hF,$NA0!"$"$k$$$O(J
...
typedef struct {
	...
	wchar_t		*kanaBuf;	/* $B$+$J/home/sundae4/donation/si/SCCS_DIRECTORIES/usr.lib/libxim/SCCS/s.XSunJclib.hC00:19:22!(J */
	wchar_t		*kanaEnd;
	wchar_t		*displayBuf;	/* $B6/14/91#%9@(#)XSunJclib.h	1.1l%$/home/sundae4/donation/si/SCCS_DIRECTORIES/usr.lib/libxim/SCCS/s.XSunJclib.hC00:19:22!(J */
	wchar_t		*displayEnd;
	jcClause	*clauseInfo;	/* $BJ8@a>pJs(J */
	struct wnn_env	*env;
    /* private member */
	int		fixed;		/* $B3NDj$5$l$?$+$I$&$+(J */
	wchar_t		*dot;		/* $B1.1C%H$N0LCV(J */
	int		candKind;	/* $BBgJ8@a$N8uJd$+>.J8@a$N8uJd$+$rI=$900:19:22i%0(J */
	...
	char		*candBuf;	/* opaque */
	int		nReset;		/* $B:#;H$C$?$h0C%H$rMn$9$Y$-(J
					 * $B%(%s9/29/91j$N?t(J */
