/*
 * $Id: cplib.h,v 1.2 1991/09/16 21:29:56 ohm Exp $
 */
...
#define  _cwnn_isyincod_d(YINcod)    ( ( (int)YINcod >= 0xa020 && \
			         (YINcod & 0x80) == 0 && \
				 (((int)YINcod >>(int)2 ) & 0x1f) != 0x1f && \
		        (int)((((int)YINcod >>(int)9)&0x3f)-0x10) < PY_NUM_YUNMU  ) \
...
#define Shengraw(YINcod) (((int)((YINcod - 0xa020) & 0x7c)>>(int)2) + 0x01)

/* Yunraw based on PinYin table  */
#define Yunraw(YINcod) 	((int)(((YINcod) - 0xa020) & 0x7e00) >> (int)9)
