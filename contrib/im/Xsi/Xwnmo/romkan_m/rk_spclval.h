/*
 * $Id: rk_spclval.h,v 1.2 1991/09/16 21:34:52 ohm Exp $
 */
/*
...
#define	strtail(sp) {while(*(sp)) (sp)++;}
	...
	/* 限定版romkan_init3 */
#define romkan_init4(delchr, nisedl, keyin, bytecount, flg) \
	romkan_init3(delchr, nisedl, EOLTTR, \
		     keyin, bytecount, bytecount, 0, flg)

#define romkan_init5(delchr, keyin, bytecount, flg) \
	romkan_init4(delchr, toNISE(delchr), keyin, bytecount, flg)
