...
#define X_USAGE "[-display host:dpy] [-geometry geom] [-fw] [-rv]\n              [-bw <borderwidth>] [-bd <color>] [-fg <color>]\n              [-bg <color>][-bf <fontname>] [-tl <title>] [-in <icon name>] \n              [-icon <icon bitmap filename>]"
