...
#define     $DESCRIPTOR(name, string)\
            ...
            /*
             *  Macro to define any previously declared 
             *  record structured datatype into a descriptor.
             */
#define     $DESCRIPTOR_R(dsc_name, dsc_size, dsc_buff)\
                struct dsc$descriptor_s _align (QUADWORD) dsc_name = \
                { dsc_size, DSC$K_DTYPE_T, DSC$K_CLASS_S, dsc_buff }
