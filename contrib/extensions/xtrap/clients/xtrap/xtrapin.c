...
#endif
{
    ...
    char *tmp = NULL;
    INT16 ch;
    extern int optind,opterr;   /* global variables in getopt */
    extern char *optarg;        /* global variables in getopt */
    file_rec rec;
    Time last_time = 0L;

    ifp = NULL;
    opterr = 0; /* don't complain about -d for display */
    grabFlag = False;
    ...
    appW = XtAppInitialize(&app,"XTrap",optionTable,(Cardinal)1L,
        (Cardinal *)&argc, (String *)argv, (String *)NULL,(ArgList)&tmp,
        (Cardinal)NULL);
